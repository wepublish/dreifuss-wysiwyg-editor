...
exports.TableBorderColorToolbar = void 0;
...
const TableBorderColorToolbar = (props) => {
    ...
    const [borderColor, setBorderColor] = react_1.useState(DEFAULT_TD_BORDER_COLOR);
    ...
    return (jsx_runtime_1.jsxs("div", Object.assign({ onClick: () => { var _a; return (_a = textInput.current) === null || _a === void 0 ? void 0 : _a.click(); } }, { children: [(_a = props.icon) !== null && _a !== void 0 ? _a : jsx_runtime_1.jsx(common_1.BorderColorIcon, {}, void 0), jsx_runtime_1.jsx("input", { type: "color", ref: textInput, value: borderColor, onChange: e => {
                    if (!editor)
                        return;
                    const color = e.target.value;
                    if (color)
                        setBorderColor(color);
                    table_1.upsertBorderColor(editor, color);
                }, style: {
                    width: 0,
                    visibility: 'hidden'
                } }, void 0)] }), void 0));
...
//# sourceMappingURL=ToolbarBorderColor.js.map