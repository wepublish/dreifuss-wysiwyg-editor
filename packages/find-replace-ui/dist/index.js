...
const ToolbarBase = /*#__PURE__*/r__namespace.forwardRef((props, ref) => {
...
function useTimeoutFn(fn, ms) {
    if (ms === void 0) { ms = 0; }
    var ready = r__default['default'].useRef(false);
    var timeout = r__default['default'].useRef();
    var callback = r__default['default'].useRef(fn);
    var isReady = r__default['default'].useCallback(function () { return ready.current; }, []);
    var set = r__default['default'].useCallback(function () {
        ready.current = false;
    ...
    var clear = r__default['default'].useCallback(function () {
        ready.current = null;
        timeout.current && clearTimeout(timeout.current);
    }, []);
    // update ref when function changes
    r__default['default'].useEffect(function () {
        callback.current = fn;
    }, [fn]);
...
const HeadingToolbar = /*#__PURE__*/r__namespace.forwardRef((props, ref) => {
  const styles = getHeadingToolbarStyles(props);
  return /*#__PURE__*/jsxRuntime.jsx(_StyledToolbarBase, {
    ref: ref,
...
var _StyledToolbarBase = He(ToolbarBase).withConfig({
...
const ToolbarSearchHighlight = ({
  icon: Icon,
  setSearch
}) => /*#__PURE__*/jsxRuntime.jsx(HeadingToolbar, {
  styles: {
    root: {
      height: '38px'
    }
