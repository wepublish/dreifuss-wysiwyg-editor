...
import r__default, { useRef, useDebugValue, useContext, createElement } from 'react';
import 'react-dom';
...
const ToolbarBase = /*#__PURE__*/r.forwardRef((props, ref) => {
...
function useTimeoutFn(fn, ms) {
    if (ms === void 0) { ms = 0; }
    var ready = r__default.useRef(false);
    var timeout = r__default.useRef();
    var callback = r__default.useRef(fn);
    var isReady = r__default.useCallback(function () { return ready.current; }, []);
    var set = r__default.useCallback(function () {
        ready.current = false;
    ...
    var clear = r__default.useCallback(function () {
        ready.current = null;
        timeout.current && clearTimeout(timeout.current);
    }, []);
    // update ref when function changes
    r__default.useEffect(function () {
        callback.current = fn;
    }, [fn]);
...
const HeadingToolbar = /*#__PURE__*/r.forwardRef((props, ref) => {
  const styles = getHeadingToolbarStyles(props);
  return /*#__PURE__*/jsx(_StyledToolbarBase, {
    ref: ref,
