...
import {Deserialize, getPlatePluginOptions, getSlateClass} from '@udecode/plate-core'
import {ELEMENT_ALIGN_CENTER, ELEMENT_ALIGN_JUSTIFY, ELEMENT_ALIGN_RIGHT} from './defaults'
