...
import { useLayoutEffect, useRef, useCallback, forwardRef, createElement, useState, useEffect, useMemo, useContext } from 'react';
...
const getImageElementStyles = props => {
  ...
  return createStyles({
    ...
    caption: [{
      ...
      "textAlign": "right"
    }, css$1(["font:inherit;color:inherit;background-color:inherit;:focus{::placeholder{opacity:0;}}"])],
    optionsToolbar: [{
      "display": "flex",
      "alignItems": "center",
      "userSelect": "none",
    ...
    }, css$1(["color:", ";background:", ";z-index:500;border:1px solid ", ";border-radius:4px;margin-top:", "px;margin-left:", "px;.slate-ToolbarButton-active,.slate-ToolbarButton:hover{color:", ";}"], color, background, borderColor, marginTopLeft, marginTopLeft, colorActive)],
 ...
 * // => { 'a': 1, 'b': 2 }
 */
_baseRest(function(object, sources) {
 ...
 * // => { 'a': [{ 'b': 2, 'c': 3 }, { 'd': 4, 'e': 5 }] }
 */
_createAssigner(function(object, source, srcIndex) {
...
var _StyledDiv = _styled("div").withConfig({
  ...
  componentId: "lyu4jx-0"
})(["", ""], p => p._css);

var _StyledFigure = _styled("figure").withConfig({
  displayName: "ImageElement___StyledFigure",
  componentId: "lyu4jx-1"
})(["", ""], p => p._css2);

var _StyledDiv2 = _styled("div").withConfig({
  displayName: "ImageElement___StyledDiv2",
  componentId: "lyu4jx-2"
})(["", ""], p => p._css3);

var _StyledButton = _styled("button").withConfig({
  displayName: "ImageElement___StyledButton",
  componentId: "lyu4jx-3"
})(["", ""], p => p._css4);

var _StyledButton2 = _styled("button").withConfig({
  displayName: "ImageElement___StyledButton2",
  componentId: "lyu4jx-4"
})(["", ""], p => p._css5);

var _StyledButton3 = _styled("button").withConfig({
  displayName: "ImageElement___StyledButton3",
  componentId: "lyu4jx-5"
})(["", ""], p => p._css6);

var _StyledImg = _styled("img").withConfig({
  displayName: "ImageElement___StyledImg",
  componentId: "lyu4jx-6"
})(["", ""], p => p._css7);

var _StyledFigcaption = _styled("figcaption").withConfig({
  displayName: "ImageElement___StyledFigcaption",
  componentId: "lyu4jx-7"
})(["", ""], p => p._css8);

var _StyledTextareaAutosize = _styled(index).withConfig({
  displayName: "ImageElement___StyledTextareaAutosize",
  componentId: "lyu4jx-8"
})(["", ""], p => p._css9);

const ImageElement = props => {
  var _styles$figure, _styles$figure2, _styles$optionsToolba, _styles$optionsToolba2, _styles$optionsToolba3, _styles$optionsToolba4, _styles$optionsToolba5, _styles$optionsToolba6, _styles$img, _styles$img2, _styles$figcaption, _styles$figcaption2, _styles$caption, _styles$caption2;
  ...
  const [imageSize, setSize] = useState(ImageSizeType.large);
  useEffect(() => {
  ...
  }, [imageSize]); // const [captionId] = useState(nanoid());
  ...
  return /*#__PURE__*/jsxs(_StyledDiv, { ...attributes,
    ...
    children: [/*#__PURE__*/jsx("div", {
      ...
      children: /*#__PURE__*/jsxs(_StyledFigure, {
        ...
        children: [/*#__PURE__*/jsxs(_StyledDiv2, {
          className: styles.optionsToolbar.className,
          _css3: styles.optionsToolbar.css,
          children: [/*#__PURE__*/jsx(_StyledButton, {
            className: (_styles$optionsToolba = styles.optionsToolbarButton) === null || _styles$optionsToolba === void 0 ? void 0 : _styles$optionsToolba.className,
            onClick: () => setSize(ImageSizeType.large),
            _css4: (_styles$optionsToolba2 = styles.optionsToolbarButton) === null || _styles$optionsToolba2 === void 0 ? void 0 : _styles$optionsToolba2.css,
            children: "lg"
          }), /*#__PURE__*/jsx(_StyledButton2, {
            className: (_styles$optionsToolba3 = styles.optionsToolbarButton) === null || _styles$optionsToolba3 === void 0 ? void 0 : _styles$optionsToolba3.className,
            onClick: () => setSize(ImageSizeType.medium),
            _css5: (_styles$optionsToolba4 = styles.optionsToolbarButton) === null || _styles$optionsToolba4 === void 0 ? void 0 : _styles$optionsToolba4.css,
            children: "md"
          }), /*#__PURE__*/jsx(_StyledButton3, {
            className: (_styles$optionsToolba5 = styles.optionsToolbarButton) === null || _styles$optionsToolba5 === void 0 ? void 0 : _styles$optionsToolba5.className,
            onClick: () => setSize(ImageSizeType.small),
            _css6: (_styles$optionsToolba6 = styles.optionsToolbarButton) === null || _styles$optionsToolba6 === void 0 ? void 0 : _styles$optionsToolba6.css,
            children: "sm"
          })]
        }), /*#__PURE__*/jsx(_StyledImg, {
          ...
          draggable: draggable,
          ...nodeProps,
          _css7: (_styles$img2 = styles.img) === null || _styles$img2 === void 0 ? void 0 : _styles$img2.css
        }), !caption.disabled && (captionString.length || selected) && /*#__PURE__*/jsx(_StyledFigcaption, {
          style: {
            width
          },
          ...
          children: /*#__PURE__*/jsx(_StyledTextareaAutosize, {
...
var css = ".image-toolbar .input-group {\n  border: 1px solid #e5e5ea;\n  padding: 5px 5px;\n}\n\n.image-toolbar .input-group input {\n  width: 100%;\n  border: 0px;\n}\n\n.image-toolbar .form-group:not(:last-child) {\n  margin-bottom: 20px;\n}\n\n.image-toolbar .toolbar button {\n  margin-bottom: 0;\n  margin: auto 5px;\n  font-weight: normal;\n  text-align: center;\n  vertical-align: middle;\n  cursor: pointer;\n  outline: 0 !important;\n  white-space: nowrap;\n  border: none;\n  user-select: none;\n  padding: 8px 12px;\n  font-size: 14px;\n  line-height: 1.42857143;\n  border-radius: 6px;\n}\n\n.image-toolbar .toolbar button.insert {\n  color: white;\n  background-color: #0078d4;\n}\n\n.image-toolbar .toolbar button.cancel {\n  color: red;\n  background-color: #f7f7fa;\n}\n\n.image-toolbar .toolbar button.disabled {\n  color: #c5c6c7;\n  background-color: #f7f7fa;\n}\n";
n(css,{});
...
export { ImageElement, ToolbarImage, getImageElementStyles, imageSizeMap };
