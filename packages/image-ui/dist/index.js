...
const getImageElementStyles = props => {
  ...
  return plateStyledComponents.createStyles({
    ...
    }, _styled.css(["color:", ";background:", ";z-index:500;border:1px solid ", ";border-radius:4px;margin-top:", "px;margin-left:", "px;.slate-ToolbarButton-active,.slate-ToolbarButton:hover{color:", ";}"], color, background, borderColor, marginTopLeft, marginTopLeft, colorActive)],
...
var _StyledButton3 = _styled__default['default']("button").withConfig({
...
var _StyledTextareaAutosize = _styled__default['default'](index).withConfig({
...
const ImageElement = props => {
  ...
  const [imageSize, setSize] = React.useState(ImageSizeType.large);
  React.useEffect(() => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(_StyledDiv, { ...attributes,
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(_StyledFigure, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(_StyledDiv2, {
          className: styles.optionsToolbar.className,
          _css3: styles.optionsToolbar.css,
          children: [/*#__PURE__*/jsxRuntime.jsx(_StyledButton, {
            ...
            children: "lg"
          }), /*#__PURE__*/jsxRuntime.jsx(_StyledButton2, {
            ...
            children: "md"
          }), /*#__PURE__*/jsxRuntime.jsx(_StyledButton3, {
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(_StyledImg, {
        ...
        }), !caption.disabled && (captionString.length || selected) && /*#__PURE__*/jsxRuntime.jsx(_StyledFigcaption, {
          style: {
            width
          },
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(_StyledTextareaAutosize, {
...
const ToolbarImage = ({
  ...
  if (CustomComponent) return /*#__PURE__*/jsxRuntime.jsx(CustomComponent, {
    onChange: newUrl => {
      setURL(newUrl);
      if (!editor) return;
      slate.Transforms.select(editorRef, latestSelection.current);
      slateReact.ReactEditor.focus(editorRef);
      image.insertImage(editor, newUrl);
      toggleMenu();
    }
  });
...
exports.imageSizeMap = imageSizeMap;
