...
export const LinkElementBase = ({
  ...
  return (
    <a {...attributes} href={element.url} className={classNames.root} {...nodeProps}>
      {children}
    </a>
  )
}
 ...
 * LinkElement
 */
export const LinkElement = styled<StyledElementProps<LinkNodeData>, ClassName, RootStyleSet>(
  LinkElementBase,
